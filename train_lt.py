...
if __name__ == '__main__':
    ...
    #pretrain G_A and G_B
    print("Start Pretraining of G_A and G_B\n")
...
#
            ...
            model.optimize_parameters_pretrain()   # calculate loss functions, get gradients, update network weights
#
...
#
    ...
    for epoch in range(opt.epoch_count, opt.n_epochs + opt.n_epochs_decay + 1):    # outer loop for different epochs; we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>
        ...
        for i, data in enumerate(dataset):  # inner loop within one epoch
            ...
            total_iters += opt.batch_size
            epoch_iter += opt.batch_size
            model.set_input(data, postrain=True)         # unpack data from dataset and apply preprocessing
            model.optimize_parameters_postrain()   # calculate loss functions, get gradients, update network weights()   
