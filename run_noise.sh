...
# generate data
python generate.py --dataroot ./mask_all/ --name Seed42_style --augmode adv_noise --adv_loss_type pixel --random_seed 42 --load_iter initial --continue_train
# retrain model
...
python train_generative_model_TOD.py --dataroot ./mask_all/ --name Seed42_style --augmode adv_noise --adv_loss_type TOD --random_seed 42 --load_iter initial --continue_train
