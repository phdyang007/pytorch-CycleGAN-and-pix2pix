...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--n_epochs_decay_1', type=int, default=100, help='lithotwin phase 1: number of epochs to linearly decay learning rate to zero')
        parser.add_argument('--n_epochs_decay_2', type=int, default=100, help='lithotwin phase 2: number of epochs to linearly decay learning rate to zero')
