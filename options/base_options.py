...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='litho_twin', help='chooses which model to use. [cycle_gan | pix2pix | test | colorization]')
        parser.add_argument('--input_nc', type=int, default=1, help='# of input image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--output_nc', type=int, default=1, help='# of output image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--A_nc', type=int, default=1, help='# of design channels: 3 for RGB and 1 for grayscale')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='lithotwin', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization | lithotwin]')
        ...
        parser.add_argument('--update_train_round', default=0, type=int, help='identify the training set to be used for multi-round update, use together with --use-update-mask and --update_mask')
